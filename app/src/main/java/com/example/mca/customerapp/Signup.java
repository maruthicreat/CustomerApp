...
public class Signup extends AppCompatActivity {
    ...
    EditText repass,emailId,password,name,phone;
    ...
    public void storeUserData(View view)
    {
        ...
        final String nameid = name.getText().toString().trim();
        final String phoneid = phone.getText().toString().trim();
                ...
                firebaseAuth.createUserWithEmailAndPassword(emailid, passwordid).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            c_uid.child("name").setValue(nameid);
                            c_uid.child("phone").setValue(phoneid);
